...
final class NasabahTable extends PowerGridComponent
{
    ...
    public function actions(\App\Models\Nasabah $row): array
    {
        ...
        if (auth()->user()->can('update-nasabah')) {
            $actions[] = Button::add('edit')
                ...
                ->openModal('nasabah-form', ['rowId' => $row->id]);
        }

        // if (auth()->user()->can('delete-nasabah')) {
    ...
    public function header(): array
    {
        ...
        if (auth()->user()->can('create-nasabah')) {
            $header[] = Button::add('add-nasabah')
                ...
                ->openModal('nasabah-form', []);
        }

        if (auth()->user()->can('export-nasabah')) {
    ...
    {
        $nasabah = Nasabah::findOrFail($rowId);
        $nasabah->delete();
        $this->success('Nasabah berhasil dihapus');
    }
}
