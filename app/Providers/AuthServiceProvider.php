...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::define('create-data', function (User $user) {
            return $user->role->permissions->pluck('slug')->contains('create-data');
        });

        Gate::define('read-data', function (User $user) {
            return $user->role->permissions->pluck('slug')->contains('read-data');
        });

        Gate::define('update-data', function (User $user) {
            return $user->role->permissions->pluck('slug')->contains('update-data');
        });

        Gate::define('delete-data', function (User $user) {
            return $user->role->permissions->pluck('slug')->contains('delete-data');
        });
    }
}
