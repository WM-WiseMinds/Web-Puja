    ...
    <aside
        ...
        <div class="py-4 text-white dark:text-gray-400 text-center">
            ...
            <ul class="mt-6">
                ...
                <li
                    class="relative px-6 py-3 {{ request()->routeIs('sampah') ? 'bg-white' : 'text-white hover:text-white dark:hover:text-gray-200 dark:text-gray-100' }}">
                    <x-nav-link href="{{ route('sampah') }}" :active="request()->routeIs('sampah')"
                        class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 {{ request()->routeIs('sampah') ? 'text-green-700' : 'text-white hover:text-white dark:hover:text-gray-200 dark:text-gray-100' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                            <path fill-rule="evenodd"
